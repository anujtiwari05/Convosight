...
public class expertArticlePopup extends TestBase {
    public static final Logger log = Logger.getLogger(expertArticlePopup.class.getName());
    ...
    public expertArticlePopup(WebDriver driver) {
        this.driver = driver;
        PageFactory.initElements(driver, this);
    }

    public void expertArticle() throws InterruptedException {
